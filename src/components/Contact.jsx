            ...
            <div className="pt-2">
              ...
              <div className="flex items-center space-x-3">
                ...
                <a
                  ...
                  className="w-8 h-8 bg-white/5 border border-white/15 flex items-center justify-center text-[#1877F2] hover:bg-white hover:border-[#1877F2] transition-all rounded-sm group"
                >
                  <FacebookIcon className="w-4 h-4 fill-current group-hover:scale-110 transition-transform" />
                </a>
                ...
                <a
                  ...
                  className="w-8 h-8 bg-white/5 border border-white/15 flex items-center justify-center text-[#E4405F] hover:bg-white hover:border-[#E4405F] transition-all rounded-sm group"
                >
                  <InstagramIcon className="w-4 h-4 fill-current group-hover:scale-110 transition-transform" />
                </a>
                ...
                <a
                  ...
                  className="w-8 h-8 bg-white/5 border border-white/15 flex items-center justify-center text-[#0A66C2] hover:bg-white hover:border-[#0A66C2] transition-all rounded-sm group"
                >
                  <LinkedinIcon className="w-4 h-4 fill-current group-hover:scale-110 transition-transform" />
                </a>
                <a
                  ...
                  className="w-8 h-8 bg-white/5 border border-white/15 flex items-center justify-center text-[#25D366] hover:bg-white hover:border-[#25D366] transition-all rounded-sm group"
                >

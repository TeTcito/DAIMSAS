...
export default function Hero() {
  return (
    <section 
      id="inicio" 
      className="relative w-full bg-azul-marino-dark text-white min-h-[640px] lg:h-[780px] flex flex-col justify-between"
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-[30px] pb-8 sm:pb-12 w-full">
        <div className="max-w-2xl lg:max-w-3xl">
          ...
          <div className="flex flex-wrap items-center gap-4">
            <a
              href="#servicios"
              className="inline-flex items-center justify-center bg-azul-daim hover:bg-azul-daim-hover text-white font-extrabold px-8 py-3.5 text-sm rounded-sm shadow-industrial transition-all transform hover:-translate-y-0.5 active:scale-95"
            >
            ...
            <a
              href="#contacto"
              className="inline-flex items-center justify-center bg-white hover:bg-slate-100 text-azul-marino font-extrabold px-8 py-3.5 text-sm rounded-sm shadow-md transition-all transform hover:-translate-y-0.5 active:scale-95"
            >
              Contáctanos
            </a>
          </div>
      ...
      {/* 3 Tarjetas Inferiores DAIM - Superpuestas exactamente al 50% con imágenes de fondo integradas */}
      <div className="relative lg:absolute lg:bottom-0 lg:left-0 lg:right-0 z-20 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full translate-y-8 sm:translate-y-12 lg:translate-y-1/2">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-0 shadow-2xl overflow-hidden rounded-sm border border-white/10">
          ...
          <div className="bg-azul-daim text-white p-6 sm:p-8 relative overflow-hidden flex flex-col justify-between min-h-[260px] sm:min-h-[290px] group border-b md:border-b-0 md:border-r border-white/15">
            ...
            <div className="relative z-10 max-w-[240px]">
              <span className="text-[11px] font-extrabold tracking-widest text-white uppercase block mb-1 drop-shadow-md">
                COMPROMISO DAIM
              </span>
              <h3 className="text-2xl sm:text-3xl font-black text-amarillo-seguridad leading-tight drop-shadow-[0_2px_8px_rgba(0,0,0,0.95)]">
                Seguridad
              </h3>
            </div>

            <div className="relative z-10 mt-8 max-w-[240px]">
              <div className="text-4xl sm:text-5xl font-black text-white tracking-tight drop-shadow-[0_2px_8px_rgba(0,0,0,0.95)]">
                100% EPP
              </div>
              <p className="text-xs sm:text-sm text-amarillo-seguridad font-extrabold mt-1 leading-snug drop-shadow-md">
          ...
          <div className="bg-azul-marino text-white p-6 sm:p-8 relative overflow-hidden flex flex-col justify-between min-h-[260px] sm:min-h-[290px] group border-b md:border-b-0 md:border-r border-white/15">
            ...
            <div className="relative z-10 mt-8">
              <a
                href="#nosotros"
                className="inline-flex items-center space-x-2 px-4 py-2 bg-white hover:bg-slate-100 text-black font-black rounded-sm text-xs uppercase tracking-wider transition-all shadow-md active:scale-95 border border-white"
              >
                <span className="text-sm leading-none font-black text-black">+</span>
          ...
          <div className="bg-azul-marino-dark text-white p-6 sm:p-8 relative overflow-hidden flex flex-col justify-between min-h-[260px] sm:min-h-[290px] group">
            {/* Imagen de fondo completa sin sombreado */}
            <div className="absolute inset-0 pointer-events-none overflow-hidden">
              <img 
